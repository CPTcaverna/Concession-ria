...
class EditarAgendamento extends StatefulWidget {
  EditarAgendamento({ Key? key }) : super(key: key);

  @override
  State<EditarAgendamento> createState() => _EditarAgendamento();
}

class _EditarAgendamento extends State<EditarAgendamento> {
  ...
  Widget build(BuildContext context){
    ...
    void salvar() {
      final Agendamento registro = AgendamentoDaoMemory().selecionarPorId(int.parse(idController.text))!;
